define(['jquery', 'bootstrap', 'backend', 'table', 'form', 'template'], function ($, undefined, Backend, Table, Form, Template) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    "index_url": "development/auth/rule/index",
                    "add_url": "development/auth/rule/add",
                    "edit_url": "development/auth/rule/edit",
                    "del_url": "development/auth/rule/del",
                    "multi_url": "development/auth/rule/multi",
                    "table": "auth_rule"
                }
            });
                            ...
                            buttons: [
                                {
                                    ...
                                    text: '添加子类',
                                    title: function (row) {
                                        return "添加["+row.title+"]的子菜单";
                                    },
                                    icon: 'fa fa-bars fa-fw',
                                    classname: 'btn btn-xs btn-primary btn-dialog ',
                                    url: 'development/auth/rule/add'
                                }
                                ],
