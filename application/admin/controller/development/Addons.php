...
EOT;
            ...
            file_put_contents(ADDON_PATH . $name . DS . 'config/cache.php', '<?php ' . PHP_EOL . ' return ' . var_export_short($cache_arr) . ';');
            //end;
    ...
    protected function getCreateMenu($menu)
    {
        foreach ($menu as $k => &$v) {
            ...
            unset($v['id'], $v['pid'], $v['createtime'], $v['updatetime']
